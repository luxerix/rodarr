            ...
            try
            {
                ...
                if (mediaInfo != null)
                {
                    ...
                    var mediaInfoModel = new MediaInfoModel
                    {
                        ...
                        VideoFormat = mediaInfo.PrimaryVideoStream.CodecLongName,
                        VideoCodecID = mediaInfo.PrimaryVideoStream.CodecTag,
                        VideoProfile = videoProfile,
                        VideoCodecLibrary = null,
                        ...
                        Height = height,
                        Width = width,
                        AudioFormat = mediaInfo.PrimaryAudioStream.CodecLongName,
                        AudioCodecID = mediaInfo.PrimaryAudioStream.CodecTag,
                        AudioProfile = audioProfile,
                        AudioCodecLibrary = null,
                        AudioAdditionalFeatures = null,
